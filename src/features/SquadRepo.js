...
class SquadRepo {
  async listarSquads() {
    const options = {
      method: "GET",
      url:
        "https://docs.google.com/spreadsheets/d/e/2PACX-1vQZUgOf4JDOmkuERpHtazuS0Bvc1EejfIxaUgwuj16rBLyR28Bks4KP3ULgm3KXqaEjeHeeXc4BF4Dj/pub?gid=766563780&single=true&output=tsv",
      headers: {}
    };
    try {
